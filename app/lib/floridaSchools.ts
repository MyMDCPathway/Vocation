...
export const FLORIDA_SCHOOLS: School[] = [
  ...
  { id: "famu", name: "Florida A&M University", shortName: "FAMU", city: "Tallahassee", kind: "public-university", color: "#006633" },
  { id: "fau", name: "Florida Atlantic University", shortName: "FAU", city: "Boca Raton", kind: "public-university", color: "#003366" },
  { id: "fgcu", name: "Florida Gulf Coast University", shortName: "FGCU", city: "Fort Myers", kind: "public-university", color: "#00338D" },
  ...
  { id: "flpoly", name: "Florida Polytechnic University", shortName: "POLY", city: "Lakeland", kind: "public-university", color: "#582C83" },
  { id: "fsu", name: "Florida State University", shortName: "FSU", city: "Tallahassee", kind: "public-university", color: "#782F40" },
  { id: "ncf", name: "New College of Florida", shortName: "NCF", city: "Sarasota", kind: "public-university", color: "#003865" },
  { id: "ucf", name: "University of Central Florida", shortName: "UCF", city: "Orlando", kind: "public-university", color: "#BA9B37" },
  { id: "uf", name: "University of Florida", shortName: "UF", city: "Gainesville", kind: "public-university", color: "#0021A5" },
  { id: "unf", name: "University of North Florida", shortName: "UNF", city: "Jacksonville", kind: "public-university", color: "#00246B" },
  { id: "usf", name: "University of South Florida", shortName: "USF", city: "Tampa", kind: "public-university", color: "#006747" },
  { id: "uwf", name: "University of West Florida", shortName: "UWF", city: "Pensacola", kind: "public-university", color: "#004C97" },

  // --- Private (SACSCOC-accredited, curated) ------------------------------
  { id: "avemaria", name: "Ave Maria University", shortName: "AMU", city: "Ave Maria", kind: "private", color: "#00205B" },
  { id: "barry", name: "Barry University", shortName: "BU", city: "Miami Shores", kind: "private", color: "#C8102E" },
  { id: "cookman", name: "Bethune-Cookman University", shortName: "BCU", city: "Daytona Beach", kind: "private", color: "#621244" },
  { id: "eckerd", name: "Eckerd College", shortName: "EC", city: "St. Petersburg", kind: "private", color: "#006BA6" },
  { id: "ewu", name: "Edward Waters University", shortName: "EWU", city: "Jacksonville", kind: "private", color: "#4B2E83" },
  { id: "erau", name: "Embry-Riddle Aeronautical University", shortName: "ERAU", city: "Daytona Beach", kind: "private", color: "#00205B" },
  { id: "flagler", name: "Flagler College", shortName: "FC", city: "St. Augustine", kind: "private", color: "#A6192E" },
  { id: "fit", name: "Florida Institute of Technology", shortName: "FIT", city: "Melbourne", kind: "private", color: "#A6192E" },
  { id: "fmu", name: "Florida Memorial University", shortName: "FMU", city: "Miami Gardens", kind: "private", color: "#F47C30" },
  { id: "fsc", name: "Florida Southern College", shortName: "FSC", city: "Lakeland", kind: "private", color: "#A6192E" },
  { id: "ju", name: "Jacksonville University", shortName: "JU", city: "Jacksonville", kind: "private", color: "#00694E" },
  { id: "keiser", name: "Keiser University", shortName: "KU", city: "Fort Lauderdale", kind: "private", color: "#003DA5" },
  { id: "lynn", name: "Lynn University", shortName: "LU", city: "Boca Raton", kind: "private", color: "#00447C" },
  { id: "nova", name: "Nova Southeastern University", shortName: "NSU", city: "Davie", kind: "private", color: "#003893" },
  { id: "pba", name: "Palm Beach Atlantic University", shortName: "PBA", city: "West Palm Beach", kind: "private", color: "#003DA5" },
  { id: "rollins", name: "Rollins College", shortName: "RC", city: "Winter Park", kind: "private", color: "#00205B" },
  { id: "saintleo", name: "Saint Leo University", shortName: "SLU", city: "St. Leo", kind: "private", color: "#00694E" },
  { id: "stu", name: "St. Thomas University", shortName: "STU", city: "Miami Gardens", kind: "private", color: "#A6192E" },
  { id: "stetson", name: "Stetson University", shortName: "SU", city: "DeLand", kind: "private", color: "#006747" },
  { id: "miami", name: "University of Miami", shortName: "UM", city: "Coral Gables", kind: "private", color: "#005030", logo: "/logos/miami.png" },
  { id: "tampa", name: "University of Tampa", shortName: "UT", city: "Tampa", kind: "private", color: "#A6192E" },
];
