    ...
    <div className="min-h-screen bg-surface">
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="prose prose-slate max-w-none space-y-6 text-on-surface-variant">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-on-surface mt-8 mb-4">3. AI-Generated Content Disclaimer</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-on-surface mt-8 mb-4">4. Educational Disclaimer</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-on-surface mt-8 mb-4">5. User Responsibilities</h2>
            <p>You agree to:</p>
            <ul className="list-disc pl-6 space-y-2 mt-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-on-surface mt-8 mb-4">7. Third-Party Services</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-on-surface mt-8 mb-4">9. Changes to Terms</h2>
            <p>
